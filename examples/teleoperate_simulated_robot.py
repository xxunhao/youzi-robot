...
from youzi_robot.interface.dynamixel import Dynamixel
from youzi_robot.interface.robot import Robot
...
if __name__ == "__main__":
    ...
    m = mujoco.MjModel.from_xml_path(os.path.join(ASSETS_PATH, "reach_cube.xml"))
    d = mujoco.MjData(m)
